...
GAME_AUTHORS = (
  "Athanasios Kasampalis <faif at gnu period org>",
  "Efstathios Xatzikiriakidis <lafs at ixthis period gr>",
  "Nikolaos Delis <delis89gmail.com>",
  "Dhmhtrios Ventas <rayone99@gmail.com>",
  "Mixahl Kasampalis <michaelkas@hotmail.com>"
)
